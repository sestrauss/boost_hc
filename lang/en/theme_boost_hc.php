...
$string['choosereadme'] = 'Theme Boost HC is a child theme of Boost. It adds the ability to customize the login page.';                
...
$string['configtitle'] = 'Boost HC settings';                                                                                          
// Name of the first settings tab.                                                                                                  
$string['generalsettings'] = 'General settings';                                                                                    
// The name of our plugin.                                                                                                          
$string['pluginname'] = 'Boost HC';                                                                                                    
